...
- Checkout Flutter parity advanced:
  ...
  - Cart/Checkout micro-parity advanced under the UX/UI-first test-light
    ...
    and lighter wallet-note footer. Cart grouping, reservation release, checkout
