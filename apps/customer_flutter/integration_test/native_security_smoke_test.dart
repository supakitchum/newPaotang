...
void main() {
  ...
  testWidgets('native biometric key signs and clears a challenge',
      (tester) async {
    if (!Platform.isIOS && !Platform.isAndroid) return;
    ...
    final challenge = 'native-security-${DateTime.now().microsecondsSinceEpoch}';
  ...
  testWidgets('Android biometric key clears after enrollment changes',
      (tester) async {
    const holdSeconds = int.fromEnvironment(
