...
void main(List<String> args) {
  ...
  final input = ProductionPreflightInput(
    ...
    projectRoot: options.value('project-root') ??
        Platform.environment['CUSTOMER_FLUTTER_PROJECT_ROOT'] ??
        '.',
    apiBaseUrl: options.value('api-base-url') ??
