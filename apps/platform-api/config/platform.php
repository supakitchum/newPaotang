...
return [
    ...
    'realtime' => [
        ...
        'customer_client' => env('CUSTOMER_REALTIME_CLIENT', 'customer-flutter'),
        'customer_auth_endpoint' => env('CUSTOMER_REALTIME_AUTH_ENDPOINT', '/customer/realtime/auth'),
        'customer_protocol' => max(1, (int) env('CUSTOMER_REALTIME_PROTOCOL', 7)),
