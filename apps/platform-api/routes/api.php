...
use App\Modules\Pricing\Http\Controllers\PublicSalePriceStreamController;
...
Route::get('/public/sale-price/stream', [PublicSalePriceStreamController::class, 'stream']);
