...
class FanoutCustomerPushInstallationsJob implements ShouldBeUnique, ShouldQueue
{
    use Dispatchable;
    ...
    public function __construct(
        ...
        public readonly ?string $afterDeviceId = null,
    ) {
    ...
    {
        $notifications->fanOutInstallationChunk(
            $this->notificationId,
            $this->audienceType,
            $this->afterDeviceId,
        );
