...
export const menuSections = [
  {
    title: 'ประวัติ',
    items: ['ประวัติการซื้อสลากฯ', 'ประวัติขึ้นเงินรางวัลสลากดิจิทัล', { label: 'ระบบตัวแทนจำหน่าย', to: '/affiliate' }]
  },
  {
    title: 'ตั้งค่ารับเงินรางวัล',
    items: [{ label: 'ช่องทางรับเงินรางวัล', to: '/profile/reward-bank' }, 'ขึ้นเงินรางวัลอัตโนมัติ', 'ที่อยู่ใบเสร็จรับเงิน/ใบกำกับภาษี']
  },
  {
