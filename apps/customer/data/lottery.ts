...
export const menuSections = [
  {
    title: 'ประวัติ',
    items: [{ label: 'กระเป๋าเงิน', to: '/my-wallet' }, { label: 'ประวัติการซื้อสลากฯ', to: '/purchase-history' }, { label: 'ประวัติขึ้นเงินรางวัลสลากดิจิทัล', to: '/reward-claims' }, { label: 'ประวัติขึ้นเงินรางวัลกิจกรรม', to: '/activity-claims' }, { label: 'กิจกรรม', to: '/activities', badge: 'ใหม่' }, { label: 'ระบบตัวแทนจำหน่าย', to: '/affiliate' }]
  },
  {
