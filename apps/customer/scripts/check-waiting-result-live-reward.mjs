...
expect('waiting result keeps live draft rewards marked unofficial', page.includes(':unofficial="isUnofficialReward"') && page.includes('const isUnofficialReward = computed(() => isUnofficialRewardResult(rewardGame.value))'))
