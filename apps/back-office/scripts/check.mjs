...
for (const evidence of [
  ...
  ['central stock table realtime workflow', operationsPage.includes('private-admin.central.stock.table.game') && operationsPage.includes("eventName: 'stock.table.updated'") && operationsPage.includes('stockTableRealtimeEnabled') && operationsPage.includes('handleStockTableRealtimeEvent') && operationsPage.includes('handleStockTableRealtimeReconnect') && operationsPage.includes('reloadStockTableFromRealtime') && operationsPage.includes('stockTableRealtimeRowRequiresReload') && operationsPage.includes('mergeStockTableRealtimeRow') && operationsPage.includes('refreshStockSummaryWidgets') && operationsPage.includes('useAdminRealtimeSubscription')],
