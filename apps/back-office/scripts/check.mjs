...
for (const evidence of [
  ...
  ['mobile horizontal header logo', adminFoundationCss.includes('.np-admin-brand-logo.desktop-logo') && adminFoundationCss.includes('display: block !important') && adminFoundationCss.includes('max-width: 6.75rem')],
