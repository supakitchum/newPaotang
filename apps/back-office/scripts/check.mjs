...
for (const evidence of [
  ...
  ['sidebar horizontal Siamblend logo', adminFoundationCss.includes('.np-sidebar-brand-header') && adminFoundationCss.includes('.np-admin-brand-logo.desktop-logo') && adminFoundationCss.includes('display: block !important')],
