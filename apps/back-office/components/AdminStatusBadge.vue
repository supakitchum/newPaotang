...
const badgeClass = computed(() => {
  ...
  if (['active', 'approved', 'available', 'completed', 'success', 'ok', 'online', 'true'].includes(status)) return 'bg-success-transparent text-success'
  ...
  if (['revoked', 'cancelled', 'ended', 'expired', 'inactive', 'offline', 'unavailable', 'sold_out', 'false'].includes(status)) return 'bg-secondary-transparent text-secondary'
