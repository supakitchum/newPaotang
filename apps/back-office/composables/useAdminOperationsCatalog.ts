      ...
      },
      {
        ...
        formFields: [
          ...
          }),
          {
            ...
            type: 'select',
            options: [
              { value: 'quota_random', label: 'Quota / top-up stock' },
              { value: 'virtual_profile', label: 'Virtual profile' },
            ],
            defaultValue: 'quota_random',
            hideEmptyOption: true,
            required: true,
            help: 'Quota/top-up creates physical stock rows; virtual profile updates base capacity settings.',
          },
          {
            key: 'total_count',
